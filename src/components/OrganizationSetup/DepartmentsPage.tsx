        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              The Departments module will allow you to define and manage internal departments 
              classified as L1, L2, or L3 functions within your organization.
            </p>
            <div className="bg-gray-50 rounded-lg p-6">
              <h4 className="font-semibold text-gray-900 mb-3">Planned Features:</h4>
              <ul className="text-left text-gray-600 space-y-2">
                <li>• Create and manage department hierarchies</li>
                <li>• Classify departments by function level (L1, L2, L3)</li>
                <li>• Assign department heads and members</li>
                <li>• Link departments to organizational structure</li>
                <li>• Track department responsibilities and risk ownership</li>
              </ul>
            </div>
          </div>
        </div>

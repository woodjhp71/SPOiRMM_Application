...
exports.onUserDocumentDeleted = exports.deleteUserCompletely = void 0;
...
exports.deleteUserCompletely = functions.https.onCall(async (data, context) => {
    ...
    if (!uid || typeof uid !== 'string') {
        throw new functions.https.HttpsError('invalid-argument', 'User UID is required and must be a string');
    }
    try {
        // Check if the requesting user has admin privileges
        const requestingUserDoc = await db.collection('users').doc(context.auth.uid).get();
        if (!requestingUserDoc.exists) {
            throw new functions.https.HttpsError('permission-denied', 'Requesting user not found in database');
        }
        const requestingUserData = requestingUserDoc.data();
        const requestingUserRoles = (requestingUserData === null || requestingUserData === void 0 ? void 0 : requestingUserData.roles) || [];
        ...
        await db.collection('auditLogs').add({
            action: 'user_deleted',
            targetUserId: uid,
            targetUserEmail: (userData === null || userData === void 0 ? void 0 : userData.email) || 'unknown',
            performedBy: context.auth.uid,
            performedByEmail: (requestingUserData === null || requestingUserData === void 0 ? void 0 : requestingUserData.email) || 'unknown',
            timestamp: admin.firestore.FieldValue.serverTimestamp(),
            details: {
                userRoles: (userData === null || userData === void 0 ? void 0 : userData.roles) || [],
                userDisplayName: (userData === null || userData === void 0 ? void 0 : userData.displayName) || 'unknown'
            }
        });
        return {
            success: true,
        ...
        throw new functions.https.HttpsError('internal', 'Failed to delete user: ' + (error instanceof Error ? error.message : 'Unknown error'));
    }
});
/**
...
exports.onUserDocumentDeleted = functions.firestore
    ...
    try {
        ...
        await db.collection('auditLogs').add({
            ...
            targetUserId: userId,
            targetUserEmail: (deletedUserData === null || deletedUserData === void 0 ? void 0 : deletedUserData.email) || 'unknown',
            performedBy: 'system',
            timestamp: admin.firestore.FieldValue.serverTimestamp(),
            details: {
                reason: 'Automatic cleanup after Firestore deletion',
                userRoles: (deletedUserData === null || deletedUserData === void 0 ? void 0 : deletedUserData.roles) || [],
                userDisplayName: (deletedUserData === null || deletedUserData === void 0 ? void 0 : deletedUserData.displayName) || 'unknown'
            }
        });
    }
    catch (error) {
